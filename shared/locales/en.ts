export const en = {
  ...
  learn: {
    ...
    failedToLoad: "Failed to load review snippets",
    progress: "Snippet",
    keyboardHint: "Use up/down arrows to reveal more and left/right to move between snippet's content",
    rawText: "Raw text",
    context: "Context",
    examples: "Examples",
    translation: "Translation",
    revealContext: "Show context",
    revealExamples: "Show examples",
    revealTranslation: "Show translation",
    nextSnippet: "Next snippet",
    previousSnippet: "Previous snippet",
    noContext: "No contextual explanation available.",
    noExamples: "No examples available.",
    noTranslation: "No translation available.",
    noSnippets: "No snippets are available for review yet.",
  },
