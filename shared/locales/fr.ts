...
export const fr: TranslationKeys = {
  ...
  learn: {
    ...
    failedToLoad: "Échec du chargement des extraits de révision",
    progress: "Extrait",
    keyboardHint: "Utilisez ↓ pour révéler davantage et → pour passer au suivant",
    rawText: "Texte brut",
    context: "Contexte",
    examples: "Exemples",
    translation: "Traduction",
    revealContext: "Afficher le contexte",
    ...
    noSnippets: "Aucun extrait n'est encore disponible pour la révision.",
  },
